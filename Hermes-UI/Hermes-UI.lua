...
_G[AddonName] = LibStub("AceAddon-3.0"):NewAddon(mod, AddonName, "AceConsole-3.0", "AceEvent-3.0", "AceTimer-3.0")
...
function mod:OnEnable() --OnSetHermesPluginProfile is always called before OnEnable is called
	...
	Hermes:RegisterHermesEvent("OnStartReceiving", AddonName, function()
		self:OnStartReceiving()
	end)
	Hermes:RegisterHermesEvent("OnStopReceiving", AddonName, function()
		self:OnStopReceiving()
	end)
	Hermes:RegisterHermesEvent("OnInventorySpellAdded", AddonName, function(id)
		ViewManager:OnInventorySpellAdded(id)
	end)
	Hermes:RegisterHermesEvent("OnInventoryItemAdded", AddonName, function(id)
		ViewManager:OnInventoryItemAdded(id)
	end)
	Hermes:RegisterHermesEvent("OnInventorySpellRemoved", AddonName, function(id)
		ViewManager:OnInventorySpellRemoved(id)
	end)
	Hermes:RegisterHermesEvent("OnInventoryItemRemoved", AddonName, function(id)
		ViewManager:OnInventoryItemRemoved(id)
	end)
	Hermes:RegisterHermesEvent("OnInventorySpellChanged", AddonName, function(id)
		ViewManager:OnInventorySpellChanged(id)
	end)
	Hermes:RegisterHermesEvent("OnInventoryItemChanged", AddonName, function(id)
		ViewManager:OnInventoryItemChanged(id)
	end)
...
function mod:HookEvents(hook)
	if hook and hook == true then
		Hermes:RegisterHermesEvent("OnSenderAdded", AddonName, function(sender)
			ViewManager:OnSenderAdded(sender)
		end)
		Hermes:RegisterHermesEvent("OnSenderRemoved", AddonName, function(sender)
			ViewManager:OnSenderRemoved(sender)
		end)
		Hermes:RegisterHermesEvent("OnSenderVisibilityChanged", AddonName, function(sender)
			ViewManager:OnSenderVisibilityChanged(sender)
		end)
		Hermes:RegisterHermesEvent("OnSenderOnlineChanged", AddonName, function(sender)
			ViewManager:OnSenderOnlineChanged(sender)
		end)
		Hermes:RegisterHermesEvent("OnSenderDeadChanged", AddonName, function(sender)
			ViewManager:OnSenderDeadChanged(sender)
		end)
		...
		Hermes:RegisterHermesEvent("OnAbilityAdded", AddonName, function(ability)
			ViewManager:OnAbilityAdded(ability)
		end)
		Hermes:RegisterHermesEvent("OnAbilityRemoved", AddonName, function(ability)
			ViewManager:OnAbilityRemoved(ability)
		end)
		Hermes:RegisterHermesEvent("OnAbilityAvailableSendersChanged", AddonName, function(ability)
			ViewManager:OnAbilityAvailableSendersChanged(ability)
		end)
		Hermes:RegisterHermesEvent("OnAbilityTotalSendersChanged", AddonName, function(ability)
			ViewManager:OnAbilityTotalSendersChanged(ability)
		end)

		Hermes:RegisterHermesEvent("OnAbilityInstanceAdded", AddonName, function(instance)
			ViewManager:OnInstanceAdded(instance)
		end)
		Hermes:RegisterHermesEvent("OnAbilityInstanceRemoved", AddonName, function(instance)
			ViewManager:OnInstanceRemoved(instance)
		end)
		Hermes:RegisterHermesEvent("OnAbilityInstanceStartCooldown", AddonName, function(instance)
			ViewManager:OnInstanceStartCooldown(instance)
		end)
		Hermes:RegisterHermesEvent("OnAbilityInstanceUpdateCooldown", AddonName, function(instance)
			ViewManager:OnInstanceUpdateCooldown(instance)
		end)
		Hermes:RegisterHermesEvent("OnAbilityInstanceStopCooldown", AddonName, function(instance)
			ViewManager:OnInstanceStopCooldown(instance)
		end)
		Hermes:RegisterHermesEvent("OnAbilityInstanceAvailabilityChanged", AddonName, function(instance)
			ViewManager:OnInstanceAvailabilityChanged(instance)
		end)
	else
...
do
	local LSM = LibStub("LibSharedMedia-3.0", true) or error("Required library LibSharedMedia-3.0 not found!")

	function mod:MediaFetch(mediatype, key, default)
		return (key and LSM:Fetch(mediatype, key)) or (default and LSM:Fetch(mediatype, default)) or default
	end

	function mod:MediaList(mediatype)
		return LSM:HashTable(mediatype)
	end

	function mod:RegisterMedia(mediatype, key, path)
